...
namespace gateway.Controllers
{
    ...
    public class NotificationControllerProxy : BaseController
    {
        ...
        public NotificationControllerProxy(INotificationGrpcClient notificationGrpcClient)
        {
        ...
        {
            var response = await _notificationGrpcClient.GetAllNotification(new GrpcServices.GetNotificationByUserPrivateId() { UserId = userId });
